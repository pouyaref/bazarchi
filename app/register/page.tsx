...
import { Smartphone, UserPlus, ArrowRight, User } from "lucide-react";
  ...
  const handleRequestOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({ phone, name: name.trim() || undefined, step: "request" }),
      });
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ phone, name: name.trim() || undefined, otp, step: "verify" }),
      });
      ...
      <div className="container mx-auto px-4 py-8 md:py-16">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">ایجاد حساب کاربری</h1>
            <p className="text-sm text-slate-600">با شماره موبایل خود ثبت‌نام کنید</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pr-12 pl-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    dir="rtl"
                  />
                </div>
              </div>
